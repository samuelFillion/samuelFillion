    ...
    return Vt.NodeList && !NodeList.prototype.forEach && (NodeList.prototype.forEach = function(e, t) {
        ...
        function(e, g) {
            ...
            if (!Cn(On("html"), Jt)) {
                ...
                }), w && (S.version = "3.0.4", S.setAutoScrolling = _, S.setRecordHistory = Q, S.setScrollingSpeed = J, S.setFitToSection = K, S.setLockAnchors = function(e) {
                    g.lockAnchors = e
            ...
            function ye(e) {
                g.autoScrolling && xe(e) && d.m.up && qn(e)
            }
